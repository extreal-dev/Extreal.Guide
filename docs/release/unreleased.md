...
- RedisのPub/Subによる大規模マルチプレイができる機能を追加しました。([Doc](../integration/multiplay.redis-pubsub.md))

### Extreal.SampleApp.Holiday

#### Changed

- マルチプレイをRedisのPub/Subで実現するように変更しました。([Doc](../sample-app/intro.md), [PR](https://github.com/extreal-dev/Extreal.SampleApp.Holiday/pull/11))
